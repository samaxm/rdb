...
public class User {
	...
	public User(String id, String unionid, String openid, String icon,
			String name, String password, String area, Integer worth,
			String sign, Integer sex, String phone, Integer version, String type) {
		super();
		this.id = id;
